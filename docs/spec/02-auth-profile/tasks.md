...
|---|---|---|---|---|
| T01 | Routes auth (login/register/password/verify/logout) | P0 | done | `routes/auth.php` |
| T02 | Controllers Auth Breeze | P0 | done | `app/Http/Controllers/Auth/*` |
| T03 | Pages Vue Auth/* | P0 | done | Login, Register, Forgot/Reset, Verify, Confirm |
